...
[![CI](https://github.com/NUHuiyingSun/distributed-notification-service/actions/workflows/ci.yml/badge.svg)](https://github.com/NUHuiyingSun/distributed-notification-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/NUHuiyingSun/distributed-notification-service.git
